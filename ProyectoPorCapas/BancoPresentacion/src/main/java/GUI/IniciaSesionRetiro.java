 ...
 * @author delll
 */
public class IniciaSesionRetiro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Inicio de Sesion para retirar");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(IniciaSesionRetiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new IniciaSesionRetiro().setVisible(true);
            }
        });
    }
